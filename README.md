...
- **Generative background music** — a bar-at-a-time jazz composer in the SimCity 2000 / Transport Tycoon lineage, rendered live through MeltySynth and a bundled GM soundfont. The band plays a *setlist*: discrete tunes (~4–6 min) with their own form (12-bar blues, minor blues, 32-bar AABA, bossa, funk vamp, nocturne — one in 3/4), key, tempo, lead/comping palette, and drum kit, with proper endings, breaks, and count-ins. Choruses alternate heads and solos (trading fours with the drums, brass backgrounds, occasional half-step gear change). The game steers it all: traffic density drives band energy, the in-game hour picks the repertoire (morning shuffle → midday bossa → evening funk → nocturnes after dark), day rollover rotates the tune, camera zoom fades the band toward ambient pads, congestion raises musical tension, and a clearing jam resolves it with a ii–V–I cadence — response strengths tunable in Settings → Music. Full design reference: [MUSIC.md](MUSIC.md)
